    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 via-white to-gray-50">
            ...
            <div className="p-6 space-y-3">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  ...
                  <strong> ₱200</strong> at ipapasa sa affiliate bilang kita.
      ...
      <section className="bg-gradient-to-b from-gray-50 to-green-50 py-12">
        <div className="max-w-3xl mx-auto px-5">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-500 text-sm mt-1">I-click at drag ang orange (seller) or blue (rider) na dot sa line at makita ang sample na dami ng mga referrals para makita ang potensyal na kita bawat buwan</p>
          </div>
      ...
      <section className="py-12 px-5">
        <div className="max-w-3xl mx-auto bg-gray-900 rounded-3xl p-8 text-center">
          ...
          <p className="text-gray-400 text-sm mb-5">Mag-register na bilang affiliate partner at magsimulang mag-refer ng mga seller at rider. May account ka na sa GoPalengke? Gamitin ang parehong email at phone number — awtomatikong makakonekta ang affiliate account mo sa iyong existing account.</p>
          <button
            onClick={() => navigate('/affiliate/register')}
