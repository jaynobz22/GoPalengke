...
const SOCIAL_PLATFORMS = [
  ...
  { id: 'messenger', name: 'Messenger', color: '#00B2FF', shareUrl: (url: string, text: string) => `https://www.facebook.com/dialog/send?app_id=140586622674355&link=${encodeURIComponent(url)}&redirect_uri=${encodeURIComponent(url)}` },
];
